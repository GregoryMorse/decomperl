...
-define(LibPath, code:root_dir() ++ "/lib/"). %os:getenv("ProgramFiles") ++ "/erl9.3/lib/"). %/usr/lib/erlang/lib
-define(OTPPath, os:getenv("OTPCOMPTEST")). %os:getenv("USERPROFILE") ++ "/Downloads/otp_src_20.3/test").
...
decomp_otp() ->
	decomp_dir(?OTPPath, false, "temp/compiler_test", [writeast,compile,stubfuncs]).
